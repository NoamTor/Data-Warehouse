...
select 	b.neighborhood as 'Neighborhood', count(r.review_id) as 'Number of reviews', avg(r.review_stars) as 'Avarage stars', count(b.business_id) as 'Number of Businesses in Neightborhood'
